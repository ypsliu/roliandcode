...
public final class DownStreamBean implements IDownStream {
	 ...
	 * @param serial 流水号
	 */
	public DownStreamBean(String source, String target, int type, byte serial) {
	 ...
	 * @param body 业务协议部分
	 */
	public DownStreamBean(String source, String target, int type, byte[] body) {
	 ...
	 * @param object 对象
	 */
	public <T extends Object> DownStreamBean(String source, String target, int type, T object) {
	 ...
	 * @param bytes 协议体
	 */
	private byte[] buildOuterProtocol(String source, String target, int type, byte[] bytes) {
	 ...
	 * @return 流水号
	 */
	private int serial(String target) {
