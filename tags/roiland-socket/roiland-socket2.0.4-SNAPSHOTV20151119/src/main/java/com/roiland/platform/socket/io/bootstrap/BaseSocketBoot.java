...
public abstract class BaseSocketBoot {
    ...
    public BaseSocketBoot() {
    	this.iSocketRcvBuf = Integer.valueOf(System.getProperty(SocketProperties.SOCKET_RCV_BUF, "" + 256 * 1024));
    	this.iSocketSndBuf = Integer.valueOf(System.getProperty(SocketProperties.SOCKET_SND_BUF, "" + 256 * 1024));
