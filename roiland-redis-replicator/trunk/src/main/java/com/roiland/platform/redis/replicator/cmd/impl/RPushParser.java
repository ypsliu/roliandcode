 ...
 */
public class RPushParser implements CommandParser<RPushParser.RPushCommand> {


    @Override
    public RPushCommand parse(CommandName cmdName, Object[] params) {
        int idx = 0, newIdx = 0;
