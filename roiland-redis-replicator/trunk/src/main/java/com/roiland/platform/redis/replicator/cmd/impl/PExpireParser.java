 ...
 */
public class PExpireParser implements CommandParser<PExpireParser.PExpireCommand> {
    @Override
    ...
    public static class PExpireCommand implements Command {
        ...
        public CommandName name() {
            return CommandName.name("PEXPIRE");
        }
    }
}
