 ...
 */
public class HKeysParser implements CommandParser<HKeysParser.HKeysCommand> {
    @Override
    public HKeysCommand parse(CommandName cmdName, Object[] params) {
