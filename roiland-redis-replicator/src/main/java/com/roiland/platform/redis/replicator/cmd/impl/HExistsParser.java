 ...
 */
public class HExistsParser implements CommandParser<HExistsParser.HExistsCommand> {

    @Override
    public HExistsCommand parse(CommandName cmdName, Object[] params) {
        int idx = 0;
    ...
    public static class HExistsCommand implements Command {
        ...
        public CommandName name() {
            return CommandName.name("HEXISTS");
        }
    }
}
