 ...
 * 实验性的功能
 * 打开此实验性功能，需要以下步骤
 * 1. 注释掉{@link RoilandBasicProperties#disconnect()}方法中的内容，改成注册{@link Runtime#addShutdownHook}关闭zookeeper连接
...
public class AutoDiscoveryPropertyListener extends PropertyListener.Adaptor {
    ...
    private static class Context {
        private RoilandBasicProperties properties;
        private PropertyListener listener;
        private String key;
        private String value;
        private String from;

        public Context(RoilandBasicProperties properties, PropertyListener listener, String key, String value, String from) {
        ...
        public RoilandBasicProperties getProperties() {
            return properties;
        }

        public void setProperties(RoilandBasicProperties properties) {
            this.properties = properties;
        }
